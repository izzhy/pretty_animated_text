...
class ChimeBellTextState extends State<ChimeBellText> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    final double intervalStep = intervalStepByOverlapFactor(wordCount, overlapFactor);
